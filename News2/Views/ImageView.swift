...
struct ImageView: View {
    ...
    var body: some View {
        ZStack{
            URLImageBookmarkView(urlString:articles.urlToImage)
    ...
    var checkBookmark: some View {
        Image(systemName: viewModel.isBookmarkPressed(article: articles) ? "bookmark.fill" : "bookmark")
            .foregroundColor( .white)
